...
/* In this example, all classes implememnts the interface. However, is possible to mantain the abstract class shape with the abstract method to calculate the area and at same time implement the interface for all classes or to only the new one Circle class. */
